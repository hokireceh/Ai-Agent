...
const GROQ_ALL_KEYS = [...new Set(
  [process.env.GROQ_API_KEY, process.env.GROQ_ADMIN_API_KEY].filter(Boolean)
)];
const GROQ_ADMIN_KEYS = GROQ_ALL_KEYS; // alias untuk admin pool
