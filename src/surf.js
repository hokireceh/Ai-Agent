...
const CRYPTO_REGEX = new RegExp([
  ...
  // Kata kunci crypto
  '\\b(bitcoin|ethereum|crypto|blockchain|defi|nft|token|coin|airdrop|tge|token generation|testnet|mainnet|wallet|metamask|web3|dex|cex|swap|liquidity|yield|farming|staking|bridge|layer2|l2|rollup|zk|optimistic|arbitrum|optimism|base|polygon|solana|avalanche|bsc|binance|coinbase|bybit|okx|kucoin|gate|kraken|bitget)\\b',
  // Perp DEX protocols
  '\\b(hyperliquid|extended|lighter|ethereal|drift|jupiter perp|gmx|gains|gns|kwenta|synthetix|perp protocol|vertex|aevo|rabbitx|orderly|zeta|backpack|paradex|elixir|ostium)\\b',
